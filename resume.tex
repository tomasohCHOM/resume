...
{\textbf{vimaroo} $|$ \emph{SvelteKit, TypeScript, TailwindCSS,
    Supabase, Monaco, Vim}}{\footnotesize\faIcon{link} \href{https://vimaroo.vercel.app}{vimaroo.vercel.app}}
\resumeItemListStart
...
\resumeItemListStart
\resumeItem{Developed a Discord webhook to send Advent Of Code daily challenges to a server with \textbf{2000+} members}
...
{\textbf{Association for Computing Machinery} $|$
  \footnotesize{Team Lead, Board Officer, Open Source Contributor}}{Jan 2023
  -- Present}
\resumeProjectHeading
{\textbf{FullyHacks} $|$
  \footnotesize{FullyHacks 2024 Web Dev Officer, Incoming Web Dev Team Lead for FullyHacks 2025}}{Sep 2023
  -- Present}
\resumeSubHeadingListEnd
